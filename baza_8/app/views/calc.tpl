...
<div class="pure-menu pure-menu-horizontal bottom-margin">
  ...
  <form  action="{$conf->action_root}calcCompute" method="post">
    ...
    <input type="submit"  class="btn btn-primary mt-2 mb-2 " style=" margin-left: 10px;"  value="Oblicz i zapisz do bazy"  />
    {if $user->role==admin}
    <a href="{$conf->action_root}calcList" class="btn btn-primary mt-2 mb-2 ">Zobać historie</a>
    {/if}
    {if $user->role==user}
      <p class="btn btn-primary disabled  mt-2 mb-2 ">Zobać historie</p>
    {/if}
